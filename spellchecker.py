...
def spellcheck(word, wordsmap):
    ...
    selected_set = wordsmap[length -1] + wordsmap[length] + wordsmap[length + 1] + wordsmap[length + 2] + wordsmap[length + 3]
    dist = 1000
    ...
    for w in selected_set:
        ...
        calcdist = Levenshtein.distance(word, w)
...
if __name__ == '__main__':
    ...
    wordsmap = dictparse('new-luganda-words.txt')
